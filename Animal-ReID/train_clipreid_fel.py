...
if __name__ == '__main__':
    ...
    model = make_model(cfg, num_class=num_classes, camera_num=camera_num, view_num = view_num, use_feature_enhancer = True)
    model.load_param(cfg.TEST.WEIGHT)
    loss_func, center_criterion = make_loss(cfg, num_classes=num_classes)

    optimizer_3stage, optimizer_center_3stage = make_optimizer_2stage(cfg, model, center_criterion)
    scheduler_3stage = WarmupMultiStepLR(optimizer_3stage, cfg.SOLVER.STAGE2.STEPS, cfg.SOLVER.STAGE2.GAMMA, cfg.SOLVER.STAGE2.WARMUP_FACTOR,
