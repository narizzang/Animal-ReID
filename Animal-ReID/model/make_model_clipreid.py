...
class build_transformer(nn.Module):
    def __init__(self, num_classes, camera_num, view_num, cfg, use_feature_enhancer=False):
    ...
    def forward(self, x = None, label=None, get_image = False, get_text = False, get_feat = False, cam_label= None, view_label=None):
        ...
        # if text_features is not None and get_image == False and get_text == False and self.feature_enhancer_layer:
...
def make_model(cfg, num_class, camera_num, view_num, use_feature_enhancer):
    model = build_transformer(num_class, camera_num, view_num, cfg, use_feature_enhancer)
    return model
